...
{
    internal class ElavanBoss : GameScene
    {
        ...
        public String Scene = "ElavanBoss";
        ...
        public void LoadContent(ContentManager Content, GameWindow Window, Texture2D pixel, GraphicsDevice graphicsDevice)
        {
            ...
            scalesize = 1;
            tilesize = 40;
            TileMap = LoadMap("Map Data/BossElavan_Tile.csv");
            CollisionMap = LoadMap("Map Data/BossElavan_Coliision.csv");/*
            ElavanSound = Content.Load<SoundEffect>("Sounds/Erawan");*/
        ...
        public void Update(GameTime gameTime , GameWindow Window)
        {
            ...
            if (Elavan.Health <=0 && Elavan.Position.Y > 1000)
            {
                Scene = "Map";
            }
        }
