...
{
    internal class KrutBoss : GameScene
    {
        ...
        public void LoadContent(ContentManager Content, GameWindow Window, Texture2D pixel, GraphicsDevice graphicsDevice)
        {
            ...
            scalesize = 1;
            tilesize = 40;
            TileMap = LoadMap("Map Data/BossKrut_Tile.csv");
            CollisionMap = LoadMap("Map Data/BossKrut_Coliision.csv");
            ...
            Kruttex = Content.Load<Texture2D>("Sprites/Krut_Sheet");
            spike = Content.Load<Texture2D>("Sprites/Boss_3_ATK_EF");
            flame = Content.Load<Texture2D>("Sprites/Boss_3_ATK2_EF");
            Krut = new Krut(Kruttex, new Vector2(0 * 40, 0 * 40), new Vector2(200, 175), Color.White, Window, spike,flame);
            ...
            Tile = Content.Load<Texture2D>("TileMap/clouddddd");
        ...
        public void Update(GameTime gameTime , GameWindow Window)
        {
            ...
            if (Krut.Health <= 0 && Krut.Position.Y > 1000)
            {
                Scene = "Map";
            }
        }
